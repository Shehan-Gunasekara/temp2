...
const slides: Slide[] = [
  {
    ...
    description:
      "Start by uploading your AI-generated image or any image you want to add speech to.",
    icon: <Image className="w-8 h-8" />,
    color: "from-purple-500/20 to-blue-500/20",
    image: "/images/features/choose-your-image.png",
  },
  {
    title: "Explain the video in prompt input",
    description: "Explain the video you want to create in a few sentences.",
    icon: <Mic className="w-8 h-8" />,
    color: "from-blue-500/20 to-green-500/20",
    image: "/images/features/describe-the-video.png",
  },
  {
    title: "Generate Video",
    description:
      "Our AI will generate a video with the same character and style as your image.",
    icon: <Wand2 className="w-8 h-8" />,
    color: "from-green-500/20 to-yellow-500/20",
    image: "/images/features/generating-videoc.png",
  },
  {
    title: "Ready to Share",
    description:
      "Download your video with the same character and style as your image.",
    icon: <Play className="w-8 h-8" />,
    color: "from-yellow-500/20 to-red-500/20",
    image: "/images/features/output-videoc.png",
  },
];

export function ConsistentCharacterBanner() {
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className="text-center mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4 bg-gradient-to-br from-black to-black/60 bg-clip-text text-transparent">
            Introducing Consistent Character
          </h2>
          <p className="text-base lg:text-xl text-black/60 max-w-2xl mx-auto">
            Generate a video with the same character and style as your image
          </p>
        </div>
            ...
            >
              ...
              <div className="text-center md:text-left space-y-6">
                ...
                <div>
                  ...
                  <p className="text-black/60 text-base sm:text-lg max-w-md mb-6">
                  ...
                  <Button
                    ...
                    className="bg-black hover:bg-black/80 text-white px-8 py-2.5 rounded-full font-medium inline-flex items-center gap-2 group"
                  >
                    Try it now
